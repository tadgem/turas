...
namespace turas
{
	namespace Rendering
	{
		...
		static void			DispatchStaticMeshDrawCommands(VkCommandBuffer cmd, uint32_t frame_index, View* view, u64 shader_hash,
														   lvk::VkPipelineData pipeline_data, Scene* scene);
	}; // namespace Rendering
} // namespace turas
