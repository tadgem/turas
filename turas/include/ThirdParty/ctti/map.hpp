...
namespace ctti {
    ...
    struct symbol_mapping {
        ...
        template<typename Source, typename Sink>
        auto operator()(const Source &source, SourceSymbol, Sink &sink, SinkSymbol) const ->
        ctti::meta::void_t<decltype(std::declval<Function>()(ctti::get_member_value<SourceSymbol>(source),
    ...
    constexpr ctti::symbol_mapping<SourceSymbol, SinkSymbol, ctti::meta::decay_t<Function>>
    mapping(const Function &function) {
        return {function};
    }
