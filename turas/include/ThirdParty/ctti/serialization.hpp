...
#include <ThirdParty/ctti/symbol.hpp>
#include <ThirdParty/ctti/model.hpp>
#include <ThirdParty/ctti/detail/nlohmann_json.hpp>
#include <vector>
...
namespace ctti {
    ...
    namespace serialization {
        ...
        namespace detail {
            template<typename T, bool IsEnum = std::is_enum<T>(), bool EmptyModel =
        ...
        ctti::meta::enable_if_t<ctti::has_model<Enum>::value && std::is_enum<Enum>::value, std::string>
        enum_to_string(const Enum value) {
            std::string output;
        ...
        template<typename Enum>
        ctti::meta::enable_if_t<ctti::has_model<Enum>::value && std::is_enum<Enum>::value, Enum>
        enum_from_string(const std::string &enum_string) {
            Enum enum_value{};
        ...
        namespace detail {
            ...
            template<typename T>
            struct is_default_ostream_serializable<T, false, ctti::meta::void_t<decltype(ctti_ostream_print(
                    std::declval<ctti::type_tag<T>>()))>> : public ctti::meta::true_ {
            };
        }
