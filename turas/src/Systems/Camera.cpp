...
turas::CameraSystem::CameraSystem() : System(GetTypeHash<CameraSystem>()) { ZoneScoped; }
void				 turas::CameraSystem::OnEngineReady() { ZoneScoped; }
void				 turas::CameraSystem::OnSceneLoaded(turas::Scene* scene) { ZoneScoped; }
void				 turas::CameraSystem::OnSceneClosed(turas::Scene* scene) { ZoneScoped; }
void				 turas::CameraSystem::OnUpdate(turas::Scene* scene) { ZoneScoped; }
void				 turas::CameraSystem::OnShutdown() { ZoneScoped; }
