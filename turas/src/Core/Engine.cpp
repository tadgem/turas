...
#include "windows.h"
#endif
turas::Engine::Engine(bool enableDebugUpdate) : p_DebugUpdateEnabled(enableDebugUpdate), m_Renderer(enableDebugUpdate)
{
	ZoneScoped;
	INSTANCE			 = this;
...
static Im3d::Context s_DebugIm3dContext = Im3d::Context();
static Im3d::Context s_GameIm3dContext  = Im3d::Context();

void turas::Engine::InitIm3dContexts()
{
	// TODO: Init core contexts (game / debug) 
}
